 ...
 *
 * @FacetsWidget(
 *   id = "oe_list_pages_extended_date_filter",
 *   label = @Translation("List pages date with extended filters."),
 *   description = @Translation("A date filter widget with period specific filters."),
 * )
 */
class ExtendedDateWidget extends ListPagesWidgetBase implements TrustedCallbackInterface, ContainerFactoryPluginInterface {
