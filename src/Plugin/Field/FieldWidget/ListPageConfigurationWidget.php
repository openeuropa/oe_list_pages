...
class ListPageConfigurationWidget extends WidgetBase {
   ...
   * {@inheritdoc}
   */
  public function __construct($plugin_id, $plugin_definition, FieldDefinitionInterface $field_definition, array $settings, array $third_party_settings, ListPageConfigurationSubformFactory $subform_factory, ModuleHandlerInterface $module_handler, EntityTypeManagerInterface $entityTypeManager) {
  ...
  public function formElement(FieldItemListInterface $items, $delta, array $element, array &$form, FormStateInterface $form_state) {
    ...
    if ($bundle_entity_type_id) {
      $bundle = $this->entityTypeManager->getStorage($bundle_entity_type_id)->load($host_entity->bundle());
      if ($bundle) {
