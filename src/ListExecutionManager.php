...
class ListExecutionManager implements ListExecutionManagerInterface {
   ...
   *   The custom sort processor.
   */
  public function __construct(ListSourceFactoryInterface $listSourceFactory, EntityTypeManager $entityTypeManager, RequestStack $requestStack, LanguageManagerInterface $languageManager, ?CustomSortProcessor $customSortProcessor = NULL) {
